...
public class GenerateMovieGrid extends HttpServlet {
    ...
    public static void generateGrid(JspWriter out, HttpServletRequest request)
        ...
        out.print("<h2>a</h2>");
        out.print("<tr>");
        out.print("<td><a href=\"clickedThumb?id=2\"><img src=\"https://image.tmdb.org/t/p/w92/rQocmooj7bFKS2vZfzWBB5O12eR.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=3\"><img src=\"https://image.tmdb.org/t/p/w92/gajva2L0rPYkEWjzgFlBXCAVBE5.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=4\"><img src=\"https://image.tmdb.org/t/p/w92/p64TtbZGCElxQHpAMWmDHkWJlH2.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=5\"><img src=\"https://image.tmdb.org/t/p/w92/A5cREO9NNFYg5OmTErWsghYQF9m.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=6\"><img src=\"https://image.tmdb.org/t/p/w92/kRP5dGXDhKt7bDpXX4YBa4dRwlL.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=7\"><img src=\"https://image.tmdb.org/t/p/w92/afhAUuWVB7k7PjJUd4lwO3rzhSq.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=8\"><img src=\"https://image.tmdb.org/t/p/w92/d0vReo0jcMhBjCLYZAFqWHcb7Lj.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("<td><a href=\"clickedThumb?id=9\"><img src=\"https://image.tmdb.org/t/p/w92/kV9R5h0Yct1kR8Hf8sJ1nX0Vz4x.jpg\" width=\"100\" class=\"post-img\"></a></td>");
        out.print("</tr>");
        out.print("<tr>");

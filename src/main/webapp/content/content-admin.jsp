...
<div id="content" style="height:473px; width:800px;">
        ...
        <form action="crudUser" method="GET">
            <table>
                ...
                <tr>
                    ...
                    <td><input ${userIdAutofocus} type="text" name="userId" id="inputField" size="25" maxlength="45" value="${detailsUserId}"/><br/></td>
                </tr>
                <tr></tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input ${catalogNameAutofocus} type="text" name="catalogName" size="25" maxlength="45" value="${detailsCatalogName}"/></td>
                </tr>
                <tr>
                    <td align="right">Date Active:</td>
                    <td><input ${dateActiveAutofocus} type="text" name="dateActive" size="25" maxlength="45" value="${detailsDateActive}"/></td>
                </tr>
                <tr>
                    <td></td>
    ...
    <div style="width:50px; border:1px; float:left;">
        ...
        <h2>Sats</h2>
<!--        <form action="crudMovieStats" method="GET">    -->
            <input type="submit" name="adminPageButton" value="Reset" /><br/>
            <input type="submit" name="adminPageButton" value="Reset All"/>
<!--        </form>   -->
    </div>
    </form>
</div>
